...
print(utils.get_freebusy(opts.url, start=datetime.datetime(2000, 1, 1).replace(tzinfo=pytz.timezone('UTC')), end=datetime.datetime.utcnow().replace(tzinfo=pytz.timezone('UTC'))))
